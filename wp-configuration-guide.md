...
- Search for "WP Graph QL" at the top of the page and select the WPGraphQL plugin.

![Install new plugin](./docs/plugins-install-new.png)

- Once the plugin has been added, activate it from either the **Activate Plugin** button displayed after uploading or from the **Plugins** page.

![WPGraphQL installed](./docs/plugin-installed.png)

- The [WPGraphQL](https://www.wpgraphql.com/) comes with **GraphiQL IDE** which gives you access to a GraphQL IDE directly from your WordPress Admin, allowing you to inspect and play around with the GraphQL API.

![GraphiQL IDE](./docs/wp-graphiql.png)
...
- To add [authentication to WPGraphQL](https://docs.wpgraphql.com/guides/authentication-and-authorization/), first you need to add (upload) the [WPGraphQL JWT plugin](https://github.com/wp-graphql/wp-graphql-jwt-authentication) to your WordPress **Plugins**:

![WPGraphQL JWT plugin](./docs/plugins-wpgraphql-jwt.png)

- Once the plugin has been added, activate it from from the **Plugins** page.

![WPGraphQL JWT installed](./docs/plugin-jwt-installed.png)
...
Once that's done, you'll need to access the WordPress filesystem to add the secret required to validate JWT tokens. We recommend using SFTP — the instructions vary depending on your hosting provider.

Then, open `wp-config.php` and add a Secret for your JWT:
...
Now, if you go to `http://localhost:3000`, you won’t see the post. However, if you enable **Preview Mode**, you'll be able to see the change ([Preview Mode documentation](https://nextjs.org/docs/advanced-features/preview-mode)).
